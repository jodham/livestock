<div class="home-content">
      <div class="sales-boxes">
        <div class="recent-sales box">
          ...
          <div class="title">Add Breed</div>
            <div class="sales-details">
                    <form class="inputform row" enctype="multipart/form-data" action="<?= base_url()."pig/add_breed"?>" method="post">
                        <div class="form-group col-md-4">
                            <label for="breed" class="control-label">Breed Name:</label>
                            <input type="text" id="breed" value="<?= $breed?>" name="breed" class="form-control form-control-sm">
                        </div>
